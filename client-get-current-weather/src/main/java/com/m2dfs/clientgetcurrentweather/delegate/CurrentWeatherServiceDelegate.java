...
@Service
@Api(value = "CurrentWeatherServiceDelegate", description = "With a fall back method, we get the current weather data from other services endpoints by using the city name")
